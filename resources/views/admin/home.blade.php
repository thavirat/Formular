                    ...
                    <div class="card-body pt-2 pb-1">
                        ...
                        <div role="button" class="d-flex flex-wrap align-items-center my-2 bgc-secondary-l4 bgc-h-secondary-l3 radius-1 p-25 d-style">
                            <span class="mr-25 w-4 h-4 overflow-hidden text-center border-1 brc-secondary-m2 radius-round shadow-sm d-zoom-2">
                                <img alt="Alexa's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar3.jpg') }}" class="h-4 w-4" />
                            </span>
                        ...
                        <div role="button" class="d-flex flex-wrap align-items-center my-2 bgc-secondary-l4 bgc-h-secondary-l3 radius-1 p-25 d-style">
                            <span class="mr-25 w-4 h-4 overflow-hidden text-center border-1 brc-secondary-m2 radius-round shadow-sm d-zoom-2">
                                <img alt="Derek's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar2.png') }}" class="h-4 w-4" />
                            </span>
                        ...
                        <div role="button" class="d-flex flex-wrap align-items-center my-2 bgc-secondary-l4 bgc-h-secondary-l3 radius-1 p-25 d-style">
                            <span class="mr-25 w-4 h-4 overflow-hidden text-center border-1 brc-secondary-m2 radius-round shadow-sm d-zoom-2">
                                <img alt="Antonio's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar1.jpg') }}" class="h-4 w-4" />
                            </span>
                        ...
                        <div role="button" class="d-flex flex-wrap align-items-center my-2 bgc-secondary-l4 bgc-h-secondary-l3 radius-1 p-25 d-style">
                            <span class="mr-25 w-4 h-4 overflow-hidden text-center border-1 brc-secondary-m2 radius-round shadow-sm d-zoom-2">
                                <img alt="Gabriel's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar2.jpg') }}" class="h-4 w-4" />
                            </span>
                        ...
                        <div role="button" class="d-flex flex-wrap align-items-center my-2 bgc-secondary-l4 bgc-h-secondary-l3 radius-1 p-25 d-style">
                            <span class="mr-25 w-4 h-4 overflow-hidden text-center border-1 brc-secondary-m2 radius-round shadow-sm d-zoom-2">
                                <img alt="David's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar5.png') }}" class="h-4 w-4" />
                            </span>
                        ...
                        <div role="button" class="d-flex flex-wrap align-items-center my-2 bgc-secondary-l4 bgc-h-secondary-l3 radius-1 p-25 d-style">
                            <span class="mr-25 w-4 h-4 overflow-hidden text-center border-1 brc-secondary-m2 radius-round shadow-sm d-zoom-2">
                                <img alt="Jason's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar6.jpg') }}" class="h-4 w-4" />
                            </span>
                        ...
                        <div role="button" class="d-flex flex-wrap align-items-center my-2 bgc-secondary-l4 bgc-h-secondary-l3 radius-1 p-25 d-style">
                            <span class="mr-25 w-4 h-4 overflow-hidden text-center border-1 brc-secondary-m2 radius-round shadow-sm d-zoom-2">
                                <img alt="Rebecca's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar7.jpg') }}" class="h-4 w-4" />
                            </span>
                            ...
                            <div class="px-3 conversation mt-425">
                                <div class="d-flex align-items-start col px-0">
                                    <div class="mr-3 mt-2px">
                                        <div class="pos-rel">
                                            <img alt="Max's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar1.jpg') }}" class="radius-round w-4 h-4" />
                            ...
                            <div class="px-3 conversation text-right mt-425">
                                <div class="d-flex flex-row-reverse align-items-start col px-0">
                                    <div class="ml-3 mt-2px">
                                        <div class="pos-rel">
                                            <img alt="Mia's avatar" src="{{ asset('assets/admin/assets/image/avatar/avatar7.jpg') }}" class="radius-round w-4 h-4" />
                                    ...
                                    <div class="col px-0">
                                        ...
                                        <div class="d-flex mb-15 pos-rel">
                                            ...
                                            <div class="mt-2px pos-rel">
                                                <div class='d-flex'>
                                                    <div class='border-1 radius-2 mx-1 brc-primary-l1 shadow-sm d-style overflow-hidden'><img alt='Heedphones' src="{{ asset('assets/admin/assets/image/product/wireless-headphone.jpg') }}" width='64' class='d-zoom-2' /></div>
                                                    <div class='border-1 radius-2 mx-1 brc-primary-l1 shadow-sm d-style overflow-hidden'><img alt='Speakers' src="{{ asset('assets/admin/assets/image/product/smart-speaker.jpg') }}" class='d-zoom-2' width='64' /></div>
                                                    <div class='border-1 radius-2 mx-1 brc-primary-l1 shadow-sm d-style overflow-hidden'><img alt='Shoes' src="{{ asset('assets/admin/assets/image/product/running-shoes.jpg') }}" class='d-zoom-2' width='64' /></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@endsection
@section('js')
    <script src="{{ asset('assets/admin/views/pages/dashboard/@page-script.js') }}"></script>
@endsection
