                        ...
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-bordered" id="productTable">
                                    <thead>
                                        <tr>
                                            <th width="3%" class="text-center">{{__('ITM')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" class="form-control qty_order" name="qty_order[]" value="{{ $item->qty }}" step="any" readonly></td> <td><input type="number" class="form-control qty" name="qty[]" value="{{ $item->qty }}" step="any"></td> <td><input type="number" class="form-control unit_price" name="unit_price[]" value="{{ $item->price_per_item }}" step="any"></td>
