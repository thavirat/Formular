    ...
    <div class="page-header mb-2 pb-2 flex-column flex-sm-row align-items-start align-items-sm-center py-25 px-1">
        ...
        <div class="page-tools mt-3 mt-sm-0 mb-sm-n1">
             @if( $my_menu_permission[$currentMenu->url]['p'] == 'T' )
                 <a href="{{ url("admin/Currency/ExportPrint") }}" target="_blank" class="btn btn-light-warning btn-h-warning btn-a-warning border-0 radius-3 py-2 text-600 text-90">
            ...
            @if( $my_menu_permission[$currentMenu->url]['ep'] == 'T' )
                <a href="{{ url("admin/Currency/ExportPDF") }}" target="_blank" class="btn btn-light-danger btn-h-danger btn-a-danger border-0 radius-3 py-2 text-600 text-90">
                    <span class="d-none d-sm-inline mr-1">
                        PDF
                    </span>
            ...
            @if( $my_menu_permission[$currentMenu->url]['ee'] == 'T' )
                <a href="{{ url("admin/Currency/ExportExcel") }}" target="_blank" class="btn btn-light-primary btn-h-primary btn-a-primary border-0 radius-3 py-2 text-600 text-90">
                    <span class="d-none d-sm-inline mr-1">
                        Excel
                    </span>
        ...
        <div class="col-12">
            <div class="card dcard">
                <div class="card-body p-0">
                    ...
                    <table id="tableCurrency" class="table table-border-x brc-secondary-l4 border-0 mb-0 w-100">
                ...
                <form id="FormAdd" data-parsley-validate="true">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="add_symbol">สัญลักษณ์</label>
                                    <input type="text" name="symbol" id="add_symbol" class="form-control " >
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="add_buying_sight">Buying Sight</label>
                                    <input type="text" name="buying_sight" id="add_buying_sight" class="form-control " >
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="add_buying_transfer">Transfer</label>
                                    <input type="text" name="buying_transfer" id="add_buying_transfer" class="form-control " >
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="add_selling">Selling</label>
                                    <input type="text" name="selling" id="add_selling" class="form-control " >
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="add_mid_rate">Mid Rate</label>
                                    <input type="text" name="mid_rate" id="add_mid_rate" class="form-control " >
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="FormEdit" data-parsley-validate="true">
                    <input type="hidden" id="Currency_edit_id">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="edit_symbol">สัญลักษณ์</label>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="edit_buying_sight">Buying Sight</label>
                                    <input type="text" name="buying_sight" id="edit_buying_sight" class="form-control " >
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="edit_buying_transfer">Transfer</label>
                                    <input type="text" name="buying_transfer" id="edit_buying_transfer" class="form-control " >
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="edit_selling">Selling</label>
                                    <input type="text" name="selling" id="edit_selling" class="form-control " >
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="edit_mid_rate">Mid Rate</label>
                                    <input type="text" name="mid_rate" id="edit_mid_rate" class="form-control " >
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    var tableCurrency = $('#tableCurrency').dataTable({
        ...
        "columns": [
            ...
            {"data": "buying_sight", "name": 'buying_sight'},
            {"data": "buying_transfer", "name": 'buying_transfer'},
    ...
    $('body').on('submit', '#FormEdit', function(e){
        e.preventDefault();
        var id = $("#Currency_edit_id").val();
        var form = $(this);
        loadingButton(form.find('button[type=submit]'));
        $.ajax({
            method: "PUT",
            url: url_gb+"/admin/Currency/"+id,
            dataType : 'json',
            data: form.serialize()
            }).done(function( res ) {
                resetButton(form.find('button[type=submit]'));
