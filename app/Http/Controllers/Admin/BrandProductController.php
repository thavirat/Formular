...
use Validator;
use Storage;
class BrandProductController extends AdminController
{
    public $current_menu;

    public function __construct() {
        $this->current_menu = 'BrandProduct';
    }
    ...
    public function report(){
        $result = BrandProduct::select()->orderByDesc('id');
        return $result;
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน BrandProduct ', function ($excel) use ($data) {
            $excel->sheet('รายงาน BrandProduct', function ($sheet) use ($data) {
                $sheet->loadView('admin.BrandProduct.brand_product_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.BrandProduct.brand_product_export_print', $data);
        return $pdf->stream('BrandProduct.pdf');
    }
    ...
    public function export_pdf(Request $request){
        ...
        return view('admin.BrandProduct.brand_product_export_pdf', $data);
    }
