...
class PaymentMethodController extends AdminController
{
    ...
    public function __construct() {
        $this->current_menu = 'PaymentMethod';
    }
    ...
    public function index()
    {
        ...
        return view('admin.PaymentMethod.payment_method',$data);
    }
    ...
    public function create()
    {
        $data['SidebarMenus'] = Menu::Active()->get();
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.PaymentMethod.payment_method_create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            try {
                ...
                $PaymentMethod->name_th = $name_th;
                $PaymentMethod->name_en = $name_en;
                $PaymentMethod->save();
                DB::commit();
                $return['status'] = 1;
    ...
    public function show($id)
    {
        $PaymentMethod = PaymentMethod::find($id);
                ...
                $return['status'] = 1;
                $return['title'] = 'Get PaymentMethod';
                $return['content'] = $PaymentMethod;
                return $return;
    }
    ...
    public function edit($id)
    {
        $data['SidebarMenus'] = Menu::Active()->get();
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.PaymentMethod.payment_method_edit',$data);
    }
    ...
    public function report(){
        $result = PaymentMethod::select()->orderByDesc('id');
        return $result;
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน PaymentMethod ', function ($excel) use ($data) {
            $excel->sheet('รายงาน PaymentMethod', function ($sheet) use ($data) {
                $sheet->loadView('admin.PaymentMethod.payment_method_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.PaymentMethod.payment_method_export_print', $data);
        return $pdf->stream('PaymentMethod.pdf');
    }
    ...
    public function export_pdf(Request $request){
        ...
        return view('admin.PaymentMethod.payment_method_export_pdf', $data);
    }
