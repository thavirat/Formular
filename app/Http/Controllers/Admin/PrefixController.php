...
class PrefixController extends AdminController
{
    ...
    public function index()
    {
        ...
        return view('admin.Prefix.prefix',$data);
    }
    ...
    public function create()
    {
        ...
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.Prefix.prefix_create',$data);
    }
    ...
    public function edit($id)
    {
        ...
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.Prefix.prefix_edit',$data);
    }
    ...
    public function report(){
        $result = Prefix::select()->orderByDesc('id');
        return $result;
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน Prefix ', function ($excel) use ($data) {
            $excel->sheet('รายงาน Prefix', function ($sheet) use ($data) {
                $sheet->loadView('admin.Prefix.prefix_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.Prefix.prefix_export_print', $data);
        return $pdf->stream('Prefix.pdf');
    }
    ...
    public function export_pdf(Request $request){
        ...
        return view('admin.Prefix.prefix_export_pdf', $data);
    }
