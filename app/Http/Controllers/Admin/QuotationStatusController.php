...
use Validator;
use Storage;
class QuotationStatusController extends AdminController
{
    public $current_menu;

    public function __construct() {
        $this->current_menu = 'QuotationStatus';
    }
    ...
    public function index()
    {
        ...
        return view('admin.QuotationStatus.quotation_status',$data);
    }
    ...
    public function create()
    {
        ...
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.QuotationStatus.quotation_status_create',$data);
    }
    ...
    public function show($id)
    {
        $QuotationStatus = QuotationStatus::find($id);
                ...
                $return['status'] = 1;
                $return['title'] = 'Get QuotationStatus';
                $return['content'] = $QuotationStatus;
                return $return;
    }
    ...
    public function edit($id)
    {
        ...
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.QuotationStatus.quotation_status_edit',$data);
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            QuotationStatus::where('id' , $id)->delete();
    ...
    public function report(){
        $result = QuotationStatus::select()->orderByDesc('id');
        return $result;
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน QuotationStatus ', function ($excel) use ($data) {
            $excel->sheet('รายงาน QuotationStatus', function ($sheet) use ($data) {
                $sheet->loadView('admin.QuotationStatus.quotation_status_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.QuotationStatus.quotation_status_export_print', $data);
        return $pdf->stream('QuotationStatus.pdf');
    }
    ...
    public function export_pdf(Request $request){
        ...
        return view('admin.QuotationStatus.quotation_status_export_pdf', $data);
    }
