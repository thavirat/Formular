...
use Validator;
use Storage;
class ContactChannelController extends AdminController
{
    public $current_menu;

    public function __construct() {
        $this->current_menu = 'ContactChannel';
    }
    ...
    public function index()
    {
        ...
        return view('admin.ContactChannel.contact_channel',$data);
    }
    ...
    public function create()
    {
        $data['SidebarMenus'] = Menu::Active()->get();
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.ContactChannel.contact_channel_create',$data);
    }
    ...
    {
        $ContactChannel = ContactChannel::find($id);
             
                $return['status'] = 1;
                $return['title'] = 'Get ContactChannel';
                $return['content'] = $ContactChannel;
                return $return;
    }
    ...
    public function edit($id)
    {
        $data['SidebarMenus'] = Menu::Active()->get();
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.ContactChannel.contact_channel_edit',$data);
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            ContactChannel::where('id' , $id)->delete();
    ...
    public function report(){
        $result = ContactChannel::select()->orderByDesc('id');
        return $result;
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน ContactChannel ', function ($excel) use ($data) {
            $excel->sheet('รายงาน ContactChannel', function ($sheet) use ($data) {
                $sheet->loadView('admin.ContactChannel.contact_channel_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.ContactChannel.contact_channel_export_print', $data);
        return $pdf->stream('ContactChannel.pdf');
    }
    ...
    public function export_pdf(Request $request){
        ...
        return view('admin.ContactChannel.contact_channel_export_pdf', $data);
    }
