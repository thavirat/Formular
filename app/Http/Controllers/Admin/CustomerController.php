...
class CustomerController extends AdminController
{
    ...
    public function report(){
        $result = Customer::select()->orderByDesc('id');
        return $result;
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน Customer ', function ($excel) use ($data) {
            $excel->sheet('รายงาน Customer', function ($sheet) use ($data) {
                $sheet->loadView('admin.Customer.customer_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.Customer.customer_export_print', $data);
