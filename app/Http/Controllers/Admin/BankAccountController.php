...
class BankAccountController extends AdminController
{
    ...
    public function index()
    {
        ...
        $data['Banks'] = Bank::orderBy('name_en')->get();
        return view('admin.BankAccount.bank_account',$data);
    }
    ...
    public function create()
    {
        ...
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        $data['Banks'] = Bank::orderBy('name_en')->get();
        return view('admin.BankAccount.bank_account_create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            try {
                ...
                $BankAccount->account_branch = $account_branch;
                $BankAccount->save();
                DB::commit();
                $return['status'] = 1;
    ...
    public function show($id)
    {
        $BankAccount = BankAccount::find($id);
                ...
                $return['status'] = 1;
                $return['title'] = 'Get BankAccount';
                $return['content'] = $BankAccount;
                return $return;
    }
    ...
    public function edit($id)
    {
        ...
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        $data['Banks'] = Bank::orderBy('name_en')->get();
        return view('admin.BankAccount.bank_account_edit',$data);
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน BankAccount ', function ($excel) use ($data) {
            $excel->sheet('รายงาน BankAccount', function ($sheet) use ($data) {
                $sheet->loadView('admin.BankAccount.bank_account_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.BankAccount.bank_account_export_print', $data);
        return $pdf->stream('BankAccount.pdf');
    }
    ...
    public function export_pdf(Request $request){
        ...
        return view('admin.BankAccount.bank_account_export_pdf', $data);
    }
