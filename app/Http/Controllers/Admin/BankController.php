...
class BankController extends AdminController
{
    ...
    public function create()
    {
        $data['SidebarMenus'] = Menu::Active()->get();
        $data['currentMenu'] = Menu::where('url',$this->current_menu)->first();
        return view('admin.Bank.bank_create',$data);
    }
    ...
    public function report(){
        $result = Bank::select()->orderByDesc('id');
        return $result;
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน Bank ', function ($excel) use ($data) {
            $excel->sheet('รายงาน Bank', function ($sheet) use ($data) {
                $sheet->loadView('admin.Bank.bank_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.Bank.bank_export_print', $data);
    ...
    public function export_pdf(Request $request){
        ...
        return view('admin.Bank.bank_export_pdf', $data);
    }
