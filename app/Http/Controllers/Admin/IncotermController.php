...
class IncotermController extends AdminController
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            try {
                ...
                $Incoterm->code = $code;
                $Incoterm->description = $description;
                $Incoterm->save();
                DB::commit();
                $return['status'] = 1;
    ...
    public function report(){
        $result = Incoterm::select()->orderByDesc('id');
        return $result;
    }
    ...
    public function export_excel(Request $request){
        ...
        \Excel::create('รายงาน Incoterm ', function ($excel) use ($data) {
            $excel->sheet('รายงาน Incoterm', function ($sheet) use ($data) {
                $sheet->loadView('admin.Incoterm.incoterm_export_excel', $data);
            });
        })->export('xlsx');
    }
    ...
    public function export_print(Request $request){
        ...
        $pdf = \PDF::loadView('admin.Incoterm.incoterm_export_print', $data);
        return $pdf->stream('Incoterm.pdf');
    }
    ...
    public function export_pdf(Request $request){
        ...
        return view('admin.Incoterm.incoterm_export_pdf', $data);
    }
