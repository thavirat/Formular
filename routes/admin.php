...
Route::middleware('authAdmin:admin')->group(function () {
    ...
    foreach ($langs as $lang) {
        Route::prefix($lang)->group(function () {
                ...
                Route::get('/Product/ImportFactories', 'Admin\ProductController@import_factories');
    ...
    Route::resource('/CustomerPayment', Admin\CustomerPaymentController::class);
                ...
                Route::get('/AccountReceivable/Summary', 'Admin\AccountReceivableController@summaryData');
